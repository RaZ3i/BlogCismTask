Проект является пробой пера

pip install -r requirements.txt - установка зависимостей
(В файле много лишних зависимостей - В ДАЛЬНЕЙШЕМ УБРАТЬ!!!!!!!!!!!!!!!!!!!!)
P.s. когда-нибудь

uvicorn src.main:app --reload --port 8150 запуск
http://127.0.0.1:8150/pages/authenticate - для перехода на начальную страницу
http://127.0.0.1:8150/docs - swagger документация
